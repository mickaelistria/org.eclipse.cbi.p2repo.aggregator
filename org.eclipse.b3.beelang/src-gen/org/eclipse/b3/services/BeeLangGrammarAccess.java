...
public class BeeLangGrammarAccess extends AbstractGrammarElementFinder {
	...
	public class BuildUnitElements extends AbstractParserRuleElementFinder {
		...
		private final Group cGroup_7_0_1_15 = (Group)cAlternatives_7_0_1.eContents().get(15);
		private final Keyword cPlatformFilterKeyword_7_0_1_15_0 = (Keyword)cGroup_7_0_1_15.eContents().get(0);
		private final Keyword cColonKeyword_7_0_1_15_1 = (Keyword)cGroup_7_0_1_15.eContents().get(1);
		private final Assignment cPlatformFilterAssignment_7_0_1_15_2 = (Assignment)cGroup_7_0_1_15.eContents().get(2);
		private final RuleCall cPlatformFilterP2QLParserRuleCall_7_0_1_15_2_0 = (RuleCall)cPlatformFilterAssignment_7_0_1_15_2.eContents().get(0);
		private final Keyword cSemicolonKeyword_7_0_1_15_3 = (Keyword)cGroup_7_0_1_15.eContents().get(3);
		...
		//"platform-filter" ":" platformFilter=P2QL ";"
		public Group getGroup_7_0_1_15() { return cGroup_7_0_1_15; }

		//"platform-filter"
		public Keyword getPlatformFilterKeyword_7_0_1_15_0() { return cPlatformFilterKeyword_7_0_1_15_0; }

		//":"
		public Keyword getColonKeyword_7_0_1_15_1() { return cColonKeyword_7_0_1_15_1; }

		//platformFilter=P2QL
		public Assignment getPlatformFilterAssignment_7_0_1_15_2() { return cPlatformFilterAssignment_7_0_1_15_2; }

		//P2QL
		public RuleCall getPlatformFilterP2QLParserRuleCall_7_0_1_15_2_0() { return cPlatformFilterP2QLParserRuleCall_7_0_1_15_2_0; }

		//";"
		public Keyword getSemicolonKeyword_7_0_1_15_3() { return cSemicolonKeyword_7_0_1_15_3; }
	...
	public class InstanceOfExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cRightExprAssignment_1_2 = (Assignment)cGroup_1.eContents().get(2);
		private final RuleCall cRightExprVariableValueParserRuleCall_1_2_0 = (RuleCall)cRightExprAssignment_1_2.eContents().get(0);
		...
		//VariableValue
		public RuleCall getRightExprVariableValueParserRuleCall_1_2_0() { return cRightExprVariableValueParserRuleCall_1_2_0; }
	}
	...
	public class InfixExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cNameAssignment_1_0_2_0 = (Assignment)cGroup_1_0_2.eContents().get(0);
		private final RuleCall cNameID_or_KWParserRuleCall_1_0_2_0_0 = (RuleCall)cNameAssignment_1_0_2_0.eContents().get(0);
		private final Group cGroup_1_0_2_1 = (Group)cGroup_1_0_2.eContents().get(1);
		private final Assignment cCallAssignment_1_0_2_1_0 = (Assignment)cGroup_1_0_2_1.eContents().get(0);
		private final Keyword cCallLeftParenthesisKeyword_1_0_2_1_0_0 = (Keyword)cCallAssignment_1_0_2_1_0.eContents().get(0);
		private final Assignment cParameterListAssignment_1_0_2_1_1 = (Assignment)cGroup_1_0_2_1.eContents().get(1);
		private final RuleCall cParameterListParameterListParserRuleCall_1_0_2_1_1_0 = (RuleCall)cParameterListAssignment_1_0_2_1_1.eContents().get(0);
		private final Keyword cRightParenthesisKeyword_1_0_2_1_2 = (Keyword)cGroup_1_0_2_1.eContents().get(2);
		...
		//	CallExpression ({be::BCallFeature.funcExpr=current} "." (name=ID_or_KW (call?="(" parameterList=ParameterList? ")")?)? //	  | ({be::BFeatureExpression.objExpr=current} "." featureName=ID_or_KW)
		...
		//({be::BCallFeature.funcExpr=current} "." (name=ID_or_KW (call?="(" parameterList=ParameterList? ")")?)? //	  | ({be::BFeatureExpression.objExpr=current} "." featureName=ID_or_KW)
		//| {be::BAtExpression.objExpr=current} "[" indexExpr=Expression? "]")*
		public Alternatives getAlternatives_1() { return cAlternatives_1; }

		//{be::BCallFeature.funcExpr=current} "." (name=ID_or_KW (call?="(" parameterList=ParameterList? ")")?)?
		public Group getGroup_1_0() { return cGroup_1_0; }
		...
		//(name=ID_or_KW (call?="(" parameterList=ParameterList? ")")?)?
		...
		//ID_or_KW
		public RuleCall getNameID_or_KWParserRuleCall_1_0_2_0_0() { return cNameID_or_KWParserRuleCall_1_0_2_0_0; }

		//(call?="(" parameterList=ParameterList? ")")?
		public Group getGroup_1_0_2_1() { return cGroup_1_0_2_1; }

		//call?="("
		public Assignment getCallAssignment_1_0_2_1_0() { return cCallAssignment_1_0_2_1_0; }

		//"("
		public Keyword getCallLeftParenthesisKeyword_1_0_2_1_0_0() { return cCallLeftParenthesisKeyword_1_0_2_1_0_0; }

		//parameterList=ParameterList?
		public Assignment getParameterListAssignment_1_0_2_1_1() { return cParameterListAssignment_1_0_2_1_1; }

		//ParameterList
		public RuleCall getParameterListParameterListParserRuleCall_1_0_2_1_1_0() { return cParameterListParameterListParserRuleCall_1_0_2_1_1_0; }

		//")"
		public Keyword getRightParenthesisKeyword_1_0_2_1_2() { return cRightParenthesisKeyword_1_0_2_1_2; }
	...
	public class PrimaryExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cPropertyValueParserRuleCall_5 = (RuleCall)cAlternatives.eContents().get(5);
		...
		//PropertyValue
		public RuleCall getPropertyValueParserRuleCall_5() { return cPropertyValueParserRuleCall_5; }
	...
	public class ConstructorCallExpressionElements extends AbstractParserRuleElementFinder {
		...
		private final RuleCall cTypeExprVariableValueParserRuleCall_2_0 = (RuleCall)cTypeExprAssignment_2.eContents().get(0);
		private final Group cGroup_3 = (Group)cGroup.eContents().get(3);
		private final Keyword cLeftParenthesisKeyword_3_0 = (Keyword)cGroup_3.eContents().get(0);
		...
		//VariableValue
		public RuleCall getTypeExprVariableValueParserRuleCall_2_0() { return cTypeExprVariableValueParserRuleCall_2_0; }
	...
	public class P2QLElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "P2QL");
		private final RuleCall cSTRINGTerminalRuleCall = (RuleCall)rule.eContents().get(1);
	...
	public class TemplateElements extends AbstractParserRuleElementFinder {
		...
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
		private final Group cGroup_0 = (Group)cAlternatives.eContents().get(0);
		private final Action cBTemplateAction_0_0 = (Action)cGroup_0.eContents().get(0);
		private final Assignment cExpressionsAssignment_0_1 = (Assignment)cGroup_0.eContents().get(1);
		private final RuleCall cExpressionsTextLiteralParserRuleCall_0_1_0 = (RuleCall)cExpressionsAssignment_0_1.eContents().get(0);
		private final Group cGroup_1 = (Group)cAlternatives.eContents().get(1);
		private final Assignment cExpressionsAssignment_1_0 = (Assignment)cGroup_1.eContents().get(0);
		private final RuleCall cExpressionsTextStartLiteralParserRuleCall_1_0_0 = (RuleCall)cExpressionsAssignment_1_0.eContents().get(0);
		private final Group cGroup_1_1 = (Group)cGroup_1.eContents().get(1);
		private final Assignment cExpressionsAssignment_1_1_0 = (Assignment)cGroup_1_1.eContents().get(0);
		private final RuleCall cExpressionsTemplateExpressionParserRuleCall_1_1_0_0 = (RuleCall)cExpressionsAssignment_1_1_0.eContents().get(0);
		...
		//{be::BTemplate}
		public Action getBTemplateAction_0_0() { return cBTemplateAction_0_0; }
		...
		//TextEndLiteral
		public RuleCall getExpressionsTextEndLiteralParserRuleCall_1_2_0() { return cExpressionsTextEndLiteralParserRuleCall_1_2_0; }
	}
	...
	public class TextStartLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "TextStartLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cBLiteralExpressionAction_0 = (Action)cGroup.eContents().get(0);
		private final Assignment cValueAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cValueTEXTSTARTTerminalRuleCall_1_0 = (RuleCall)cValueAssignment_1.eContents().get(0);
		...
		//TEXTSTART
		public RuleCall getValueTEXTSTARTTerminalRuleCall_1_0() { return cValueTEXTSTARTTerminalRuleCall_1_0; }
	}

	public class TextMidLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "TextMidLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cBLiteralExpressionAction_0 = (Action)cGroup.eContents().get(0);
		private final Assignment cValueAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cValueTEXTMIDTerminalRuleCall_1_0 = (RuleCall)cValueAssignment_1.eContents().get(0);
		...
		//TEXTMID
		public RuleCall getValueTEXTMIDTerminalRuleCall_1_0() { return cValueTEXTMIDTerminalRuleCall_1_0; }
	}

	public class TextEndLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "TextEndLiteral");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Action cBLiteralExpressionAction_0 = (Action)cGroup.eContents().get(0);
		private final Assignment cValueAssignment_1 = (Assignment)cGroup.eContents().get(1);
		private final RuleCall cValueTEXTENDTerminalRuleCall_1_0 = (RuleCall)cValueAssignment_1.eContents().get(0);
	...
	public ParserRule getP2QLRule() {
		return getP2QLAccess().getRule();
	}
	...
	//TextStartLiteral returns be::BExpression:
	//	{be::BLiteralExpression} value=TEXTSTART;
	public TextStartLiteralElements getTextStartLiteralAccess() {
		return (pTextStartLiteral != null) ? pTextStartLiteral : (pTextStartLiteral = new TextStartLiteralElements());
	}
	
	public ParserRule getTextStartLiteralRule() {
		return getTextStartLiteralAccess().getRule();
	}

	//TextMidLiteral returns be::BExpression:
	//	{be::BLiteralExpression} value=TEXTMID;
	public TextMidLiteralElements getTextMidLiteralAccess() {
		return (pTextMidLiteral != null) ? pTextMidLiteral : (pTextMidLiteral = new TextMidLiteralElements());
	}
	
	public ParserRule getTextMidLiteralRule() {
		return getTextMidLiteralAccess().getRule();
	}

	//TextEndLiteral returns be::BExpression:
	//	{be::BLiteralExpression} value=TEXTEND;
	public TextEndLiteralElements getTextEndLiteralAccess() {
		return (pTextEndLiteral != null) ? pTextEndLiteral : (pTextEndLiteral = new TextEndLiteralElements());
	}
