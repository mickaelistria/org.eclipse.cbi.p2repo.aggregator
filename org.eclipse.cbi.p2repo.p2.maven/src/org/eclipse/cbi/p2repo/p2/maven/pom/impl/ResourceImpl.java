...
public class ResourceImpl extends EObjectImpl implements Resource {
	...
	public void setDirectory(String newDirectory) {
		...
		if(eNotificationRequired())
			eNotify(
				new ENotificationImpl(this, Notification.SET, PomPackage.RESOURCE__DIRECTORY, oldDirectory, directory));
	}
	...
	public void setExcludes(ExcludesType newExcludes) {
		if(newExcludes != excludes) {
			...
			if(excludes != null)
				msgs = ((InternalEObject) excludes).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - PomPackage.RESOURCE__EXCLUDES, null, msgs);
			if(newExcludes != null)
				msgs = ((InternalEObject) newExcludes).eInverseAdd(
					this, EOPPOSITE_FEATURE_BASE - PomPackage.RESOURCE__EXCLUDES, null, msgs);
			...
			eNotify(
				new ENotificationImpl(this, Notification.SET, PomPackage.RESOURCE__EXCLUDES, newExcludes, newExcludes));
	}
		...
		if(eNotificationRequired())
			eNotify(
				new ENotificationImpl(
					this, Notification.SET, PomPackage.RESOURCE__FILTERING, oldFiltering, filtering,
					!oldFilteringESet));
	}
	...
	public void setIncludes(IncludesType newIncludes) {
		if(newIncludes != includes) {
			NotificationChain msgs = null;
			if(includes != null)
				msgs = ((InternalEObject) includes).eInverseRemove(
					this, EOPPOSITE_FEATURE_BASE - PomPackage.RESOURCE__INCLUDES, null, msgs);
			if(newIncludes != null)
				msgs = ((InternalEObject) newIncludes).eInverseAdd(
					this, EOPPOSITE_FEATURE_BASE - PomPackage.RESOURCE__INCLUDES, null, msgs);
			...
			eNotify(
				new ENotificationImpl(this, Notification.SET, PomPackage.RESOURCE__INCLUDES, newIncludes, newIncludes));
	}
