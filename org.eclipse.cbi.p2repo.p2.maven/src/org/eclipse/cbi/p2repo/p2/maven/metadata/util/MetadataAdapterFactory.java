...
public class MetadataAdapterFactory extends AdapterFactoryImpl {
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.cbi.p2repo.p2.maven.metadata.DocumentRoot
	 * <em>Document Root</em>}'. <!--
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.cbi.p2repo.p2.maven.metadata.MetaData
	 * <em>Meta Data</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 *
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.cbi.p2repo.p2.maven.metadata.Versioning
	 * <em>Versioning</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 *
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.cbi.p2repo.p2.maven.metadata.Versions <em>Versions</em>}'.
	 * <!-- begin-user-doc
