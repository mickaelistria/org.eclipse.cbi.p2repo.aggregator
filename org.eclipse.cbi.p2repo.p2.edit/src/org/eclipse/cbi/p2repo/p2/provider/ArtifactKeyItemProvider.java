	...
	protected void addClassifierPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(
			createItemPropertyDescriptor(
				...
				getString(
					"_UI_PropertyDescriptor_description", "_UI_IArtifactKey_classifier_feature",
	...
	protected void addIdPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(
			createItemPropertyDescriptor(
				...
				P2Package.Literals.IARTIFACT_KEY__ID, true, false, false, ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
				null, null));
	}
