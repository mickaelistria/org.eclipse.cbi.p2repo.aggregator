 ...
 * <ul>
 * <li>{@link org.eclipse.b3.aggregator.engine.maven.pom.PluginRepositoriesType#getPluginRepository <em>Plugin
 * Repository</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.b3.aggregator.engine.maven.pom.PomPackage#getPluginRepositoriesType()
...
public interface PluginRepositoriesType extends EObject {
	 ...
	 * type {@link org.eclipse.b3.aggregator.engine.maven.pom.Repository}. <!-- begin-user-doc -->
	 * <p>
	 ...
	 * @see org.eclipse.b3.aggregator.engine.maven.pom.PomPackage#getPluginRepositoriesType_PluginRepository()
