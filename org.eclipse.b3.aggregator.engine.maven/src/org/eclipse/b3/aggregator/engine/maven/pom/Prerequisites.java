 ...
 * <ul>
 * <li>{@link org.eclipse.b3.aggregator.engine.maven.pom.Prerequisites#getMaven <em>Maven</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.b3.aggregator.engine.maven.pom.PomPackage#getPrerequisites()
...
public interface Prerequisites extends EObject
{
	 ...
	 * @see #unsetMaven()
	 * @see #setMaven(String)
	 * @see org.eclipse.b3.aggregator.engine.maven.pom.PomPackage#getPrerequisites_Maven()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.b3.aggregator.engine.maven.pom.Prerequisites#getMaven
	...
	/**
	 * Unsets the value of the '{@link org.eclipse.b3.aggregator.engine.maven.pom.Prerequisites#getMaven
	 * <em>Maven</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isSetMaven()
	 * @see #getMaven()
