 ...
 * <ul>
 * <li>{@link org.eclipse.b3.aggregator.engine.maven.pom.ReportPlugin#getGroupId <em>Group Id</em>}</li>
 * <li>{@link org.eclipse.b3.aggregator.engine.maven.pom.ReportPlugin#getArtifactId <em>Artifact Id</em>}</li>
 * <li>{@link org.eclipse.b3.aggregator.engine.maven.pom.ReportPlugin#getVersion <em>Version</em>}</li>
 * <li>{@link org.eclipse.b3.aggregator.engine.maven.pom.ReportPlugin#getInherited <em>Inherited</em>}</li>
 * <li>{@link org.eclipse.b3.aggregator.engine.maven.pom.ReportPlugin#getConfiguration <em>Configuration</em>}</li>
 * <li>{@link org.eclipse.b3.aggregator.engine.maven.pom.ReportPlugin#getReportSets <em>Report Sets</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.b3.aggregator.engine.maven.pom.PomPackage#getReportPlugin()
...
public interface ReportPlugin extends EObject
{
	 ...
	 * @see org.eclipse.b3.aggregator.engine.maven.pom.PomPackage#getReportPlugin_ArtifactId()
	 ...
	 * @see org.eclipse.b3.aggregator.engine.maven.pom.PomPackage#getReportPlugin_Configuration()
	 ...
	 * @see org.eclipse.b3.aggregator.engine.maven.pom.PomPackage#getReportPlugin_GroupId()
	 ...
	 * @see org.eclipse.b3.aggregator.engine.maven.pom.PomPackage#getReportPlugin_Inherited()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	 ...
	 * @see org.eclipse.b3.aggregator.engine.maven.pom.PomPackage#getReportPlugin_ReportSets()
	 ...
	 * @see org.eclipse.b3.aggregator.engine.maven.pom.PomPackage#getReportPlugin_Version()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	...
	/**
	 * Sets the value of the '{@link org.eclipse.b3.aggregator.engine.maven.pom.ReportPlugin#getArtifactId
	...
	/**
	 * Sets the value of the '{@link org.eclipse.b3.aggregator.engine.maven.pom.ReportPlugin#getConfiguration
	...
	/**
	 * Sets the value of the '{@link org.eclipse.b3.aggregator.engine.maven.pom.ReportPlugin#getGroupId
	...
	/**
	 * Sets the value of the '{@link org.eclipse.b3.aggregator.engine.maven.pom.ReportPlugin#getInherited
	...
	/**
	 * Sets the value of the '{@link org.eclipse.b3.aggregator.engine.maven.pom.ReportPlugin#getReportSets
	...
	/**
	 * Sets the value of the '{@link org.eclipse.b3.aggregator.engine.maven.pom.ReportPlugin#getVersion
	...
	/**
	 * Unsets the value of the '{@link org.eclipse.b3.aggregator.engine.maven.pom.ReportPlugin#getGroupId
	 * <em>Group Id</em>}' attribute. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
	 * @see #isSetGroupId()
	 * @see #getGroupId()
