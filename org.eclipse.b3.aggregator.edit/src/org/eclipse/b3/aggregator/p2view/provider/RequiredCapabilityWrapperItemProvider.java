	...
	protected void addNegationPropertyDescriptor(Object object)
	{
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IRequiredCapability_negation_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IRequiredCapability_negation_feature", "_UI_IRequiredCapability_type"),
				 P2Package.Literals.IREQUIRED_CAPABILITY__NEGATION,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.BOOLEAN_VALUE_IMAGE,
