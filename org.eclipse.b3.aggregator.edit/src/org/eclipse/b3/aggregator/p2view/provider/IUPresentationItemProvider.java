...
/**
 * This is the item provider adapter for a {@link org.eclipse.b3.aggregator.p2view.IUPresentation} object. <!--
	...
	protected void addFilterPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IUPresentation_filter_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IUPresentation_filter_feature", "_UI_IUPresentation_type"),
				 P2viewPackage.Literals.IU_PRESENTATION__FILTER,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addLabelPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IUPresentation_label_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IUPresentation_label_feature", "_UI_IUPresentation_type"),
				 P2viewPackage.Literals.IU_PRESENTATION__LABEL,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_IUPresentation_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_IUPresentation_type_feature", "_UI_IUPresentation_type"),
				 P2viewPackage.Literals.IU_PRESENTATION__TYPE,
				 false,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
