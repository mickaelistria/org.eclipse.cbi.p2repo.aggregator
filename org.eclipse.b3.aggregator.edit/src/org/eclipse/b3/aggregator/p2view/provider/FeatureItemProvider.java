...
/**
 * This is the item provider adapter for a {@link org.eclipse.b3.aggregator.p2view.Feature} object. <!--
	...
	protected void addFragmentContainerPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Feature_fragmentContainer_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Feature_fragmentContainer_feature", "_UI_Feature_type"),
				 P2viewPackage.Literals.FEATURE__FRAGMENT_CONTAINER,
				 false,
				 false,
				 true,
				 null,
