...
/**
 * This is the item provider adapter for a {@link org.eclipse.b3.aggregator.p2.UpdateDescriptor} object. <!--
...
public class UpdateDescriptorItemProvider extends AggregatorItemProviderAdapter implements IEditingDomainItemProvider,
	...
	protected void addLocationPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add(createItemPropertyDescriptor(
				((ComposeableAdapterFactory) adapterFactory).getRootAdapterFactory(), getResourceLocator(),
				getString("_UI_IUpdateDescriptor_location_feature"), getString("_UI_PropertyDescriptor_description",
						"_UI_IUpdateDescriptor_location_feature", "_UI_IUpdateDescriptor_type"),
