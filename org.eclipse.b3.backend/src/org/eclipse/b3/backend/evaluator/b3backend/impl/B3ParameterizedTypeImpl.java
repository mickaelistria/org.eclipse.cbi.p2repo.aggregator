...
public class B3ParameterizedTypeImpl extends EObjectImpl implements B3ParameterizedType {
	...
	public EList<Type> getActualArgumentsList() {
		if(actualArgumentsList == null) {
			actualArgumentsList = new EObjectEList<Type>(
				Type.class, this, B3backendPackage.B3_PARAMETERIZED_TYPE__ACTUAL_ARGUMENTS_LIST) {
			...
			if(rawType != oldRawType) {
				if(eNotificationRequired())
					eNotify(new ENotificationImpl(
						this, Notification.RESOLVE, B3backendPackage.B3_PARAMETERIZED_TYPE__RAW_TYPE, oldRawType,
						rawType));
			}
		}
		return rawType;
