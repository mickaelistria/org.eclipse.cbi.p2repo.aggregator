...
public class BIfExpressionImpl extends BExpressionImpl implements BIfExpression {
	...
	public Object evaluate(BExecutionContext ctx) throws Throwable {
		...
		if(!(cond instanceof Boolean))
			throw BackendHelper.createException(conditionExpr, 
					"If-condition is not a Boolean, was : {0}", new Object[] {cond.getClass().toString()} );
	...
	public Type getDeclaredType(BExecutionContext ctx) throws Throwable {
		return TypeUtils.getCommonSuperType(
				new Type[]{thenExpr.getDeclaredType(ctx), elseExpr.getDeclaredType(ctx)});
	}
} //BIfExpressionImpl
