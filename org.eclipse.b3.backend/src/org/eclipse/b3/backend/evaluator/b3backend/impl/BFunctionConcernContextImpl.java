 ...
 * <ul>
 * <li>{@link org.eclipse.b3.backend.evaluator.b3backend.impl.BFunctionConcernContextImpl#getNamePredicate <em>Name
 * Predicate</em>}</li>
 * <li>{@link org.eclipse.b3.backend.evaluator.b3backend.impl.BFunctionConcernContextImpl#getParameters <em>Parameters
 * </em>}</li>
 * <li>{@link org.eclipse.b3.backend.evaluator.b3backend.impl.BFunctionConcernContextImpl#getFuncExpr <em>Func Expr
 * </em>}</li>
 * <li>{@link org.eclipse.b3.backend.evaluator.b3backend.impl.BFunctionConcernContextImpl#isVarArgs <em>Var Args</em>}</li>
 * <li>{@link org.eclipse.b3.backend.evaluator.b3backend.impl.BFunctionConcernContextImpl#isMatchParameters <em>Match
 * Parameters</em>}</li>
 * </ul>
 * </p>
 * 
...
public class BFunctionConcernContextImpl extends BConcernContextImpl implements BFunctionConcernContext {
	...
	public NotificationChain basicSetFuncExpr(BExpression newFuncExpr, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3backendPackage.BFUNCTION_CONCERN_CONTEXT__FUNC_EXPR, oldFuncExpr, newFuncExpr);
			if(msgs == null)
				msgs = notification;
			else
	...
	public NotificationChain basicSetNamePredicate(BFunctionNamePredicate newNamePredicate, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3backendPackage.BFUNCTION_CONCERN_CONTEXT__NAME_PREDICATE, oldNamePredicate, newNamePredicate);
			if(msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public EList<BParameterPredicate> getParameters() {
		if(parameters == null) {
			parameters = new EObjectContainmentEList<BParameterPredicate>(BParameterPredicate.class, this,
					B3backendPackage.BFUNCTION_CONCERN_CONTEXT__PARAMETERS);
		}
		return parameters;
	}
	...
	public void setFuncExpr(BExpression newFuncExpr) {
		if(newFuncExpr != funcExpr) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					B3backendPackage.BFUNCTION_CONCERN_CONTEXT__FUNC_EXPR, newFuncExpr, newFuncExpr));
	}
	...
	public void setMatchParameters(boolean newMatchParameters) {
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					B3backendPackage.BFUNCTION_CONCERN_CONTEXT__MATCH_PARAMETERS, oldMatchParameters, matchParameters));
	}
	...
	public void setNamePredicate(BFunctionNamePredicate newNamePredicate) {
		if(newNamePredicate != namePredicate) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					B3backendPackage.BFUNCTION_CONCERN_CONTEXT__NAME_PREDICATE, newNamePredicate, newNamePredicate));
	}
	...
	public void setVarArgs(boolean newVarArgs) {
		...
		varArgs = newVarArgs;
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, B3backendPackage.BFUNCTION_CONCERN_CONTEXT__VAR_ARGS,
					oldVarArgs, varArgs));
	}
