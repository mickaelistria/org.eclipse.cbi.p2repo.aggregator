...
public class BProceedExpressionImpl extends BExpressionImpl implements BProceedExpression {
	...
	public Object evaluate(BExecutionContext ctx) throws Throwable {
		...
		if(wrappingCtx == null)
			throw B3BackendException.fromMessage(this, "A proceed expression could not find a corresponding context to proceed in.");
		IFunction original = wrappingCtx.getFunctionWrapper().getOriginal();
		return original.internalCall(
				wrappingCtx.getWrappedContext(), 
				wrappingCtx.getParameters(), 
				wrappingCtx.getParameterTypes());
	}
	@Override
