...
public class BSwitchExpressionImpl extends BExpressionImpl implements BSwitchExpression {
	...
	public NotificationChain basicSetSwitchExpression(BExpression newSwitchExpression, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3backendPackage.BSWITCH_EXPRESSION__SWITCH_EXPRESSION, oldSwitchExpression, newSwitchExpression);
			if(msgs == null)
				msgs = notification;
			else
	...
	public EList<BCase> getCaseList() {
		if(caseList == null) {
			caseList = new EObjectContainmentEList<BCase>(BCase.class, this,
					B3backendPackage.BSWITCH_EXPRESSION__CASE_LIST);
		}
		return caseList;
	}
	...
	public void setSwitchExpression(BExpression newSwitchExpression) {
		if(newSwitchExpression != switchExpression) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
					B3backendPackage.BSWITCH_EXPRESSION__SWITCH_EXPRESSION, newSwitchExpression, newSwitchExpression));
	}
