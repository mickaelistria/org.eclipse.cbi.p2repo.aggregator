...
public class AggregatorImpl extends DescriptionProviderImpl implements Aggregator {
	...
	public EList<Configuration> getConfigurations() {
		if (configurations == null) {
			configurations = new EObjectContainmentEList.Resolving<Configuration>(Configuration.class, this, AggregatorPackage.AGGREGATOR__CONFIGURATIONS);
		}
	...
	public EList<Contact> getContacts() {
		if (contacts == null) {
			contacts = new EObjectContainmentWithInverseEList.Resolving<Contact>(Contact.class, this, AggregatorPackage.AGGREGATOR__CONTACTS, AggregatorPackage.CONTACT__AGGREGATOR);
		}
		return contacts;
	}
	...
	public EList<Contribution> getContributions() {
		if (contributions == null) {
			contributions = new EObjectContainmentEList.Resolving<Contribution>(Contribution.class, this, AggregatorPackage.AGGREGATOR__CONTRIBUTIONS);
		}
	...
	public EList<CustomCategory> getCustomCategories() {
		if (customCategories == null) {
			customCategories = new EObjectContainmentEList.Resolving<CustomCategory>(CustomCategory.class, this, AggregatorPackage.AGGREGATOR__CUSTOM_CATEGORIES);
		}
	...
	public EList<MavenMapping> getMavenMappings() {
		if (mavenMappings == null) {
			mavenMappings = new EObjectContainmentEList.Resolving<MavenMapping>(MavenMapping.class, this, AggregatorPackage.AGGREGATOR__MAVEN_MAPPINGS);
		}
	...
	public EList<MetadataRepositoryReference> getValidationRepositories() {
		if (validationRepositories == null) {
			validationRepositories = new EObjectContainmentEList.Resolving<MetadataRepositoryReference>(MetadataRepositoryReference.class, this, AggregatorPackage.AGGREGATOR__VALIDATION_REPOSITORIES);
		}
