...
public class P2PackageImpl extends EPackageImpl implements P2Package {
	...
	public void initializePackageContents() {
		...
		initEAttribute(getIInstallableUnit_Filter(), this.getFilter(), "filter", "", 0, 1, IInstallableUnit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIInstallableUnit_MetaRequiredCapabilities(), this.getIRequirement(), null, "metaRequiredCapabilities", null, 0, -1, IInstallableUnit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getIInstallableUnit_RequiredCapabilities(), this.getIRequirement(), null, "requiredCapabilities", null, 0, -1, IInstallableUnit.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEOperation(iInstallableUnitFragmentEClass, this.getIRequirementArray(), "getHost", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getIRequirement_Filter(), this.getFilter(), "filter", null, 0, 1, IRequirement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getInstallableUnitFragment_HostList(), this.getRequirement(), null, "hostList", null, 0, -1, InstallableUnitFragment.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEDataType(iRequirementArrayEDataType, IRequirement[].class, "IRequirementArray", IS_SERIALIZABLE, !IS_GENERATED_INSTANCE_CLASS);
