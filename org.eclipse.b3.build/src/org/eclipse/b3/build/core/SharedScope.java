 ...
 * 
 *   bind(key)
 *       .toProvider(SharedScope.<KeyClass>seededKeyProvider())
...
public class SharedScope implements Scope {
	...
	private static final Provider<Object> SEEDED_KEY_PROVIDER = new Provider<Object>() {
		public Object get() {
			throw new IllegalStateException("If you got here then it means that"
					...
					+ " explicitly seeded in this scope by calling" + " SharedScope.seed(), but was not.");
		}
	};
	...
	private Map<Key<?>, Object> values = null;

	public void enter() {
		checkState(values == null, "A scoping block is already in progress");
		values = Maps.<Key<?>, Object> newHashMap();
	}
