...
public class BuildConcernContextImpl extends BConcernContextImpl implements BuildConcernContext {
	...
	public EList<String> getDefaultPropertiesRemovals() {
		if (defaultPropertiesRemovals == null) {
			defaultPropertiesRemovals = new EDataTypeUniqueEList<String>(String.class, this, B3BuildPackage.BUILD_CONCERN_CONTEXT__DEFAULT_PROPERTIES_REMOVALS);
		}
	...
	public NotificationChain basicSetDefaultPropertiesAdditions(BPropertySet newDefaultPropertiesAdditions, NotificationChain msgs) {
		...
		if (eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILD_CONCERN_CONTEXT__DEFAULT_PROPERTIES_ADDITIONS, oldDefaultPropertiesAdditions, newDefaultPropertiesAdditions);
	...
	public void setDefaultPropertiesAdditions(BPropertySet newDefaultPropertiesAdditions) {
		if (newDefaultPropertiesAdditions != defaultPropertiesAdditions) {
			...
			if (defaultPropertiesAdditions != null)
				msgs = ((InternalEObject)defaultPropertiesAdditions).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - B3BuildPackage.BUILD_CONCERN_CONTEXT__DEFAULT_PROPERTIES_ADDITIONS, null, msgs);
			if (newDefaultPropertiesAdditions != null)
				msgs = ((InternalEObject)newDefaultPropertiesAdditions).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - B3BuildPackage.BUILD_CONCERN_CONTEXT__DEFAULT_PROPERTIES_ADDITIONS, null, msgs);
			msgs = basicSetDefaultPropertiesAdditions(newDefaultPropertiesAdditions, msgs);
			if (msgs != null) msgs.dispatch();
		}
		else if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILD_CONCERN_CONTEXT__DEFAULT_PROPERTIES_ADDITIONS, newDefaultPropertiesAdditions, newDefaultPropertiesAdditions));
	}
	 ...
	 */
	protected boolean processProperties(BPropertySet propertySet, EList<String> removals, BPropertySet originalSet, BPropertySet additions) {
