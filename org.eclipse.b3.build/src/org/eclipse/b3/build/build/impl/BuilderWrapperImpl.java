...
public class BuilderWrapperImpl extends BFunctionWrapperImpl implements BuilderWrapper {
	...
	public EList<Capability> getProvidedCapabilities() {
		...
		if(providedCapabilities == null) {
			providedCapabilities = new EObjectContainmentEList<Capability>(Capability.class, this,
					B3BuildPackage.BUILDER_WRAPPER__PROVIDED_CAPABILITIES);
		}
	...
	public NotificationChain basicSetPostcondExpr(BExpression newPostcondExpr, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_WRAPPER__POSTCOND_EXPR, oldPostcondExpr, newPostcondExpr);
			if(msgs == null)
				msgs = notification;
			else
	...
	public void setPostcondExpr(BExpression newPostcondExpr) {
		if(newPostcondExpr != postcondExpr) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_WRAPPER__POSTCOND_EXPR,
					newPostcondExpr, newPostcondExpr));
	}
	...
	public NotificationChain basicSetPrecondExpr(BExpression newPrecondExpr, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_WRAPPER__PRECOND_EXPR, oldPrecondExpr, newPrecondExpr);
			if(msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setPrecondExpr(BExpression newPrecondExpr) {
		if(newPrecondExpr != precondExpr) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_WRAPPER__PRECOND_EXPR,
	...
	public NotificationChain basicSetInput(BuilderInput newInput, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_WRAPPER__INPUT, oldInput, newInput);
			if(msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setInput(BuilderInput newInput) {
		if(newInput != input) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_WRAPPER__INPUT, newInput,
					newInput));
	}
	...
	public NotificationChain basicSetOutput(PathGroup newOutput, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_WRAPPER__OUTPUT, oldOutput, newOutput);
			if(msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setOutput(PathGroup newOutput) {
		if(newOutput != output) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_WRAPPER__OUTPUT, newOutput,
					newOutput));
	}
	...
	public NotificationChain basicSetDefaultProperties(BPropertySet newDefaultProperties, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_WRAPPER__DEFAULT_PROPERTIES, oldDefaultProperties, newDefaultProperties);
			if(msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setDefaultProperties(BPropertySet newDefaultProperties) {
		if(newDefaultProperties != defaultProperties) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_WRAPPER__DEFAULT_PROPERTIES,
	...
	public NotificationChain basicSetPostinputcondExpr(BExpression newPostinputcondExpr, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_WRAPPER__POSTINPUTCOND_EXPR, oldPostinputcondExpr, newPostinputcondExpr);
			if(msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setPostinputcondExpr(BExpression newPostinputcondExpr) {
		if(newPostinputcondExpr != postinputcondExpr) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_WRAPPER__POSTINPUTCOND_EXPR,
	...
	/**
	 * <!-- begin-user-doc -->
	 * Sets the unit type, and copies and processes parameters. (Do not forget to also call {@link #setUnitTypeAdvised(boolean)}
	 * if the wrapper should use the wrapper's unit type instead of the original's.
	 * <!-- end-user-doc -->
	 * @generated NOT
	 */
	public void setUnitType(Class<? extends BuildUnit> newUnitType) {
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_WRAPPER__UNIT_TYPE,
	...
	public NotificationChain basicSetExplicitUnitType(Type newExplicitUnitType, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_WRAPPER__EXPLICIT_UNIT_TYPE, oldExplicitUnitType, newExplicitUnitType);
			if(msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setExplicitUnitType(Type newExplicitUnitType) {
		if(newExplicitUnitType != explicitUnitType) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_WRAPPER__EXPLICIT_UNIT_TYPE,
					newExplicitUnitType, newExplicitUnitType));
	}
	...
	public NotificationChain basicSetSource(PathGroup newSource, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_WRAPPER__SOURCE, oldSource, newSource);
			if(msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setSource(PathGroup newSource) {
		if(newSource != source) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_WRAPPER__SOURCE, newSource,
					newSource));
	}
	...
	public void setInputAdvised(boolean newInputAdvised) {
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_WRAPPER__INPUT_ADVISED,
					oldInputAdvised, inputAdvised));
	}
	...
	public void setOutputAdvised(boolean newOutputAdvised) {
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_WRAPPER__OUTPUT_ADVISED,
					oldOutputAdvised, outputAdvised));
	}
	...
	public void setUnitTypeAdvised(boolean newUnitTypeAdvised) {
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_WRAPPER__UNIT_TYPE_ADVISED,
					oldUnitTypeAdvised, unitTypeAdvised));
	}
	...
	public void setProvidesAdvised(boolean newProvidesAdvised) {
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_WRAPPER__PROVIDES_ADVISED,
					oldProvidesAdvised, providesAdvised));
	}
	...
	public void setDefaultPropertiesAdvised(boolean newDefaultPropertiesAdvised) {
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_WRAPPER__DEFAULT_PROPERTIES_ADVISED, oldDefaultPropertiesAdvised,
	...
	public void setSourceAdvised(boolean newSourceAdvised) {
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_WRAPPER__SOURCE_ADVISED,
					oldSourceAdvised, sourceAdvised));
	}
	...
	public EList<BParameterDeclaration> getParameters() {
		if(isUnitTypeAdvised())
			return super.getParametersGen(); // sneaky way around BFunctionWrapper's different treatment of getParameters()
	...
	public Type[] getParameterTypes() {
		if(isUnitTypeAdvised())
			return super.getParameterTypesGen(); // sneaky way around BFunctionWrapper's different treatment of getTypes()
