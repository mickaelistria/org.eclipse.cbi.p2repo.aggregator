...
public class BuilderJavaImpl extends BJavaFunctionImpl implements BuilderJava {
	...
	public EList<Capability> getProvidedCapabilities() {
		if(providedCapabilities == null) {
			providedCapabilities = new EObjectContainmentEList<Capability>(Capability.class, this,
					B3BuildPackage.BUILDER_JAVA__PROVIDED_CAPABILITIES);
		}
	...
	public NotificationChain basicSetPostcondExpr(BExpression newPostcondExpr, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_JAVA__POSTCOND_EXPR, oldPostcondExpr, newPostcondExpr);
			if(msgs == null)
				msgs = notification;
			else
	...
	public void setPostcondExpr(BExpression newPostcondExpr) {
		if(newPostcondExpr != postcondExpr) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_JAVA__POSTCOND_EXPR,
	...
	public NotificationChain basicSetPrecondExpr(BExpression newPrecondExpr, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_JAVA__PRECOND_EXPR, oldPrecondExpr, newPrecondExpr);
			if(msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setPrecondExpr(BExpression newPrecondExpr) {
		if(newPrecondExpr != precondExpr) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_JAVA__PRECOND_EXPR,
	...
	public NotificationChain basicSetInput(BuilderInput newInput, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_JAVA__INPUT, oldInput, newInput);
			if(msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setInput(BuilderInput newInput) {
		if(newInput != input) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_JAVA__INPUT, newInput,
					newInput));
	}
	...
	public NotificationChain basicSetOutput(PathGroup newOutput, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_JAVA__OUTPUT, oldOutput, newOutput);
			if(msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setOutput(PathGroup newOutput) {
		if(newOutput != output) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_JAVA__OUTPUT, newOutput,
					newOutput));
	}
	...
	public NotificationChain basicSetDefaultProperties(BPropertySet newDefaultProperties, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_JAVA__DEFAULT_PROPERTIES, oldDefaultProperties, newDefaultProperties);
			if(msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setDefaultProperties(BPropertySet newDefaultProperties) {
		if(newDefaultProperties != defaultProperties) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_JAVA__DEFAULT_PROPERTIES,
	...
	public NotificationChain basicSetPostinputcondExpr(BExpression newPostinputcondExpr, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_JAVA__POSTINPUTCOND_EXPR, oldPostinputcondExpr, newPostinputcondExpr);
			if(msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setPostinputcondExpr(BExpression newPostinputcondExpr) {
		if(newPostinputcondExpr != postinputcondExpr) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_JAVA__POSTINPUTCOND_EXPR,
	...
	public void setUnitType(Class<? extends BuildUnit> newUnitType) {
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_JAVA__UNIT_TYPE, oldUnitType,
					unitType));
	}
	...
	public NotificationChain basicSetExplicitUnitType(Type newExplicitUnitType, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_JAVA__EXPLICIT_UNIT_TYPE, oldExplicitUnitType, newExplicitUnitType);
			if(msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setExplicitUnitType(Type newExplicitUnitType) {
		if(newExplicitUnitType != explicitUnitType) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_JAVA__EXPLICIT_UNIT_TYPE,
	...
	public NotificationChain basicSetSource(PathGroup newSource, NotificationChain msgs) {
		...
		if(eNotificationRequired()) {
			ENotificationImpl notification = new ENotificationImpl(this, Notification.SET,
					B3BuildPackage.BUILDER_JAVA__SOURCE, oldSource, newSource);
			if(msgs == null)
				msgs = notification;
			else
				msgs.add(notification);
	...
	public void setSource(PathGroup newSource) {
		if(newSource != source) {
			...
			eNotify(new ENotificationImpl(this, Notification.SET, B3BuildPackage.BUILDER_JAVA__SOURCE, newSource,
					newSource));
	}
