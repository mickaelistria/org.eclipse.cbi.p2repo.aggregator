...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Builder Input Name Decorator</b></em>'.
 * <!-- end-user-doc -->
 * <p>
		...
		if(baseClass == INamedValue.class) {
			switch(baseFeatureID) {
				case B3backendPackage.INAMED_VALUE__NAME:
					return B3BuildPackage.BUILDER_INPUT_NAME_DECORATOR__NAME;
				default:
					return -1;
			}
		}
	...
	public void setName(String newName) {
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(
				this, Notification.SET, B3BuildPackage.BUILDER_INPUT_NAME_DECORATOR__NAME, oldName, name));
	}
