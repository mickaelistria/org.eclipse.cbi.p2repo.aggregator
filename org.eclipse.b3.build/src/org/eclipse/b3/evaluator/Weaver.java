...
/**
 * Common Weaver support.
 * 
 */
public abstract class Weaver {
	private UnitConcernContext theUnitConcern;

	private BuilderConcernContext theBuilderConcern;

	private TypePattern builderTypePattern;
	 ...
	 * @throws Throwable
	 */
	protected boolean adviseUnit(BuildUnit u, BuildContext ctx) throws Throwable {
	 ...
	 * @throws Throwable
	 */
	protected boolean adviseUnitBuilders(BuildUnit u, BExecutionContext ctx) throws Throwable {
		boolean modified = false;
	 ...
	 * @throws Throwable
	 */
	public boolean builderMatchesQuery(IBuilder candidate, BExecutionContext ctx) throws Throwable {
	 ...
	 */
	public boolean evaluateBuilderIfMatching(Object candidate, BExecutionContext ctx) throws Throwable {
	 ...
	 * 
	 */
	public boolean evaluateBuilderIfMatching(Object candidate, BExecutionContext ctx, BuildUnit promoteToUnit)
			throws Throwable {
	 ...
	 */
	public boolean evaluateUnitIfMatching(Object candidate, BExecutionContext ctx) throws Throwable {
	...
	/**
	 * @return the theBuilderConcern
	 */
	public BuilderConcernContext getBuilderConcern() {
		return theBuilderConcern;
	}

	/**
	 * @return the theUnitConcern
	 */
	public UnitConcernContext getUnitConcern() {
		return theUnitConcern;
	}
	 ...
	 */
	protected boolean processProperties(BuildConcernContext o, BPropertySet propertySet, EList<String> removals,
	 ...
	 *            the theBuilderConcern to set
	 */
	public void setBuilderConcern(BuilderConcernContext theBuilderConcern) {
		this.theBuilderConcern = theBuilderConcern;
		builderTypePattern = TypePattern.compile(theBuilderConcern.getParameters());
	}

	/**
	 * @param theUnitConcern
	 *            the theUnitConcern to set
	 */
	public void setUnitConcern(UnitConcernContext theUnitConcern) {
		this.theUnitConcern = theUnitConcern;
	}

	public boolean weaveIfMatching(BuildUnit u, BExecutionContext ctx) throws Throwable {
		Object result = evaluator.doEvaluate(theUnitConcern.getQuery(), ctx);
	...
	public void weaveIfMatching(IBuilder candidate, BExecutionContext ctx) throws Throwable {
		if(builderMatchesQuery(candidate, ctx))
			weaveIfParametersMatch(candidate, ctx, null); // do not promote
	}
	 ...
	 */
	protected boolean weaveIfParametersMatch(IBuilder b, BExecutionContext ctx, BuildUnit promoteToUnit)
			throws B3EngineException {
		Matcher matcher = builderTypePattern.match(b.getParameterTypes());
