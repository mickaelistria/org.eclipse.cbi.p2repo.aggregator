		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRepositoryAccess().getGroup_5_4(), "rule__Repository__Group_5_4__0");
					put(grammarAccess.getRepositoryAccess().getGroup_5_4_2(), "rule__Repository__Group_5_4_2__0");
					put(grammarAccess.getRepositoryAccess().getGroup_5_5(), "rule__Repository__Group_5_5__0");
					...
					put(grammarAccess.getBranchAccess().getGroup_2_3_3(), "rule__Branch__Group_2_3_3__0");
					put(grammarAccess.getBranchAccess().getGroup_2_4(), "rule__Branch__Group_2_4__0");
					put(grammarAccess.getBranchAccess().getGroup_2_4_3(), "rule__Branch__Group_2_4_3__0");
					...
					put(grammarAccess.getBeeModelAccess().getProviderAssignment_1_1_4(), "rule__BeeModel__ProviderAssignment_1_1_4");
					...
					put(grammarAccess.getBuildUnitAccess().getProviderAssignment_11_12(), "rule__BuildUnit__ProviderAssignment_11_12");
					...
					put(grammarAccess.getRepositoryAccess().getRemoteAssignment_5_0_2(), "rule__Repository__RemoteAssignment_5_0_2");
					put(grammarAccess.getRepositoryAccess().getLocalAssignment_5_1_2(), "rule__Repository__LocalAssignment_5_1_2");
					put(grammarAccess.getRepositoryAccess().getUserAssignment_5_2_2(), "rule__Repository__UserAssignment_5_2_2");
					put(grammarAccess.getRepositoryAccess().getPasswordAssignment_5_3_2(), "rule__Repository__PasswordAssignment_5_3_2");
					put(grammarAccess.getRepositoryAccess().getBranchesAssignment_5_4_1(), "rule__Repository__BranchesAssignment_5_4_1");
					put(grammarAccess.getRepositoryAccess().getBranchesAssignment_5_4_2_1(), "rule__Repository__BranchesAssignment_5_4_2_1");
					put(grammarAccess.getRepositoryAccess().getOptionsAssignment_5_5_2(), "rule__Repository__OptionsAssignment_5_5_2");
					...
					put(grammarAccess.getBranchAccess().getIncludeAssignment_2_3_2(), "rule__Branch__IncludeAssignment_2_3_2");
					put(grammarAccess.getBranchAccess().getIncludeAssignment_2_3_3_1(), "rule__Branch__IncludeAssignment_2_3_3_1");
					put(grammarAccess.getBranchAccess().getExcludeAssignment_2_4_2(), "rule__Branch__ExcludeAssignment_2_4_2");
					put(grammarAccess.getBranchAccess().getExcludeAssignment_2_4_3_1(), "rule__Branch__ExcludeAssignment_2_4_3_1");
