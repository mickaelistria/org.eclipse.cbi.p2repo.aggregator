...
public abstract class AbstractBeeLangUiModule extends BeeLangRuntimeModule {
	...
	public void configureContentAssistLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.common.editor.contentassist.antlr.internal.Lexer.class).annotatedWith(
			com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.CONTENT_ASSIST)).to(
			org.eclipse.b3.contentassist.antlr.internal.InternalBeeLangLexer.class);
	}

	// contributed by de.itemis.xtext.antlr.XtextAntlrUiGeneratorFragment
	public void configureContentAssistLexerProvider(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.b3.contentassist.antlr.internal.InternalBeeLangLexer.class).toProvider(
			org.eclipse.xtext.parser.antlr.LexerProvider.create(org.eclipse.b3.contentassist.antlr.internal.InternalBeeLangLexer.class));
	}

	// contributed by de.itemis.xtext.antlr.XtextAntlrGeneratorFragment
	public void configureHighlightingLexer(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.parser.antlr.Lexer.class).annotatedWith(
			com.google.inject.name.Names.named(org.eclipse.xtext.ui.core.LexerUIBindings.HIGHLIGHTING)).to(
	...
	public void configureXtextEditorErrorTickUpdater(com.google.inject.Binder binder) {
		binder.bind(org.eclipse.xtext.ui.core.editor.IXtextEditorCallback.class).annotatedWith(
			com.google.inject.name.Names.named("IXtextEditorCallBack")).to(
			org.eclipse.xtext.ui.core.editor.XtextEditorErrorTickUpdater.class);
	}
