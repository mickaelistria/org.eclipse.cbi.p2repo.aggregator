		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getRepositoryHandlerAccess().getGroup_5_2_2(), "rule__RepositoryHandler__Group_5_2_2__0");
					...
					put(grammarAccess.getBranchAccess().getGroup_2_3_2(), "rule__Branch__Group_2_3_2__0");
					put(grammarAccess.getBranchAccess().getGroup_2_4(), "rule__Branch__Group_2_4__0");
					put(grammarAccess.getBranchAccess().getGroup_2_4_2(), "rule__Branch__Group_2_4_2__0");
					...
					put(grammarAccess.getBeeModelAccess().getRepositoriesAssignment_1_1_4_2(), "rule__BeeModel__RepositoriesAssignment_1_1_4_2");
					...
					put(grammarAccess.getRepositoryHandlerAccess().getBranchesAssignment_5_2_2_1(), "rule__RepositoryHandler__BranchesAssignment_5_2_2_1");
					...
					put(grammarAccess.getBranchAccess().getUpdateStrategyAssignment_2_2_1(), "rule__Branch__UpdateStrategyAssignment_2_2_1");
					put(grammarAccess.getBranchAccess().getIncludeAssignment_2_3_1(), "rule__Branch__IncludeAssignment_2_3_1");
					put(grammarAccess.getBranchAccess().getIncludeAssignment_2_3_2_1(), "rule__Branch__IncludeAssignment_2_3_2_1");
					put(grammarAccess.getBranchAccess().getExcludeAssignment_2_4_1(), "rule__Branch__ExcludeAssignment_2_4_1");
					put(grammarAccess.getBranchAccess().getExcludeAssignment_2_4_2_1(), "rule__Branch__ExcludeAssignment_2_4_2_1");
					...
					put(grammarAccess.getResolutionStrategyFirstAccess().getDocumentationAssignment_1(), "rule__ResolutionStrategyFirst__DocumentationAssignment_1");
					put(grammarAccess.getResolutionStrategyFirstAccess().getRepositoriesAssignment_4(), "rule__ResolutionStrategyFirst__RepositoriesAssignment_4");
					put(grammarAccess.getResolutionStrategyBestAccess().getDocumentationAssignment_1(), "rule__ResolutionStrategyBest__DocumentationAssignment_1");
					put(grammarAccess.getResolutionStrategyBestAccess().getRepositoriesAssignment_4(), "rule__ResolutionStrategyBest__RepositoriesAssignment_4");
					put(grammarAccess.getResolutionStrategySwitchAccess().getDocumentationAssignment_1(), "rule__ResolutionStrategySwitch__DocumentationAssignment_1");
					put(grammarAccess.getResolutionStrategySwitchAccess().getRepoSwitchAssignment_3(), "rule__ResolutionStrategySwitch__RepoSwitchAssignment_3");
