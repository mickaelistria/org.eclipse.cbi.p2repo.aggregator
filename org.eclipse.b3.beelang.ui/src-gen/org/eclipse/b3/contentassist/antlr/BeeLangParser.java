		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getBuilderConcernContextAccess().getGroup_18_3(), "rule__BuilderConcernContext__Group_18_3__0");
					...
					put(grammarAccess.getBuilderAccess().getOutputAssignment_16_2(), "rule__Builder__OutputAssignment_16_2");
					put(grammarAccess.getBuilderAccess().getFuncExprAssignment_17(), "rule__Builder__FuncExprAssignment_17");
					...
					put(grammarAccess.getBuilderConcernContextAccess().getOutputAdditionsAssignment_17_0_2(), "rule__BuilderConcernContext__OutputAdditionsAssignment_17_0_2");
					put(grammarAccess.getBuilderConcernContextAccess().getOutputRemovalsAssignment_17_1_2(), "rule__BuilderConcernContext__OutputRemovalsAssignment_17_1_2");
					put(grammarAccess.getBuilderConcernContextAccess().getAnnotationsRemovalsAssignment_18_2(), "rule__BuilderConcernContext__AnnotationsRemovalsAssignment_18_2");
					put(grammarAccess.getBuilderConcernContextAccess().getAnnotationsRemovalsAssignment_18_3_1(), "rule__BuilderConcernContext__AnnotationsRemovalsAssignment_18_3_1");
					put(grammarAccess.getBuilderConcernContextAccess().getAnnotationsAdditionsAssignment_19_2(), "rule__BuilderConcernContext__AnnotationsAdditionsAssignment_19_2");
					put(grammarAccess.getBuilderConcernContextAccess().getFuncExprAssignment_20(), "rule__BuilderConcernContext__FuncExprAssignment_20");
