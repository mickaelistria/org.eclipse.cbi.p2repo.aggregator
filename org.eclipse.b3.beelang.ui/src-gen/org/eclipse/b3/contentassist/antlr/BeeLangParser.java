		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getLiteralListAccess().getEntriesAssignment_0_2(), "rule__LiteralList__EntriesAssignment_0_2");
					put(grammarAccess.getLiteralListAccess().getEntriesAssignment_0_3_1(), "rule__LiteralList__EntriesAssignment_0_3_1");
					put(grammarAccess.getLiteralListAccess().getEntryTypeAssignment_0_5_1(), "rule__LiteralList__EntryTypeAssignment_0_5_1");
					put(grammarAccess.getLiteralListAccess().getEntryTypeAssignment_1_4(), "rule__LiteralList__EntryTypeAssignment_1_4");
					put(grammarAccess.getLiteralMapAccess().getEntriesAssignment_0_2(), "rule__LiteralMap__EntriesAssignment_0_2");
					put(grammarAccess.getLiteralMapAccess().getEntriesAssignment_0_3_1(), "rule__LiteralMap__EntriesAssignment_0_3_1");
					put(grammarAccess.getLiteralMapAccess().getKeyTypeAssignment_0_5_1(), "rule__LiteralMap__KeyTypeAssignment_0_5_1");
					put(grammarAccess.getLiteralMapAccess().getValueTypeAssignment_0_5_3(), "rule__LiteralMap__ValueTypeAssignment_0_5_3");
					put(grammarAccess.getLiteralMapAccess().getKeyTypeAssignment_1_4(), "rule__LiteralMap__KeyTypeAssignment_1_4");
					put(grammarAccess.getLiteralMapAccess().getValueTypeAssignment_1_6(), "rule__LiteralMap__ValueTypeAssignment_1_6");
