		...
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				private static final long serialVersionUID = 1L;
				{
					...
					put(grammarAccess.getFunctionConcernContextAccess().getAlternatives_3_1(), "rule__FunctionConcernContext__Alternatives_3_1");
					...
					put(grammarAccess.getFunctionConcernContextAccess().getGroup_3(), "rule__FunctionConcernContext__Group_3__0");
					put(grammarAccess.getFunctionConcernContextAccess().getGroup_3_1_0(), "rule__FunctionConcernContext__Group_3_1_0__0");
					put(grammarAccess.getFunctionConcernContextAccess().getGroup_3_1_0_1(), "rule__FunctionConcernContext__Group_3_1_0_1__0");
					put(grammarAccess.getFunctionConcernContextAccess().getGroup_3_1_0_2(), "rule__FunctionConcernContext__Group_3_1_0_2__0");
					put(grammarAccess.getFunctionConcernContextAccess().getGroup_3_1_1(), "rule__FunctionConcernContext__Group_3_1_1__0");
					...
					put(grammarAccess.getFunctionConcernContextAccess().getNamePredicateAssignment_2(), "rule__FunctionConcernContext__NamePredicateAssignment_2");
					put(grammarAccess.getFunctionConcernContextAccess().getParametersAssignment_3_1_0_0(), "rule__FunctionConcernContext__ParametersAssignment_3_1_0_0");
					put(grammarAccess.getFunctionConcernContextAccess().getParametersAssignment_3_1_0_1_1(), "rule__FunctionConcernContext__ParametersAssignment_3_1_0_1_1");
					put(grammarAccess.getFunctionConcernContextAccess().getVarArgsAssignment_3_1_0_2_1(), "rule__FunctionConcernContext__VarArgsAssignment_3_1_0_2_1");
					put(grammarAccess.getFunctionConcernContextAccess().getParametersAssignment_3_1_0_2_2(), "rule__FunctionConcernContext__ParametersAssignment_3_1_0_2_2");
					put(grammarAccess.getFunctionConcernContextAccess().getVarArgsAssignment_3_1_1_0(), "rule__FunctionConcernContext__VarArgsAssignment_3_1_1_0");
					put(grammarAccess.getFunctionConcernContextAccess().getParametersAssignment_3_1_1_1(), "rule__FunctionConcernContext__ParametersAssignment_3_1_1_1");
					put(grammarAccess.getParameterPredicateAccess().getTypePredicateOpAssignment_0(), "rule__ParameterPredicate__TypePredicateOpAssignment_0");
					...
					put(grammarAccess.getParameterVarargsPredicateAccess().getTypePredicateOpAssignment_0(), "rule__ParameterVarargsPredicate__TypePredicateOpAssignment_0");
