...
public class BChainedExpressionTest extends BExpressionTest {
	...
	public void testEvaluate__BExecutionContext() {
		try {
			...
			list.add(e = b3.createBLiteralExpression()); e.setValue("a");
			list.add(e = b3.createBLiteralExpression()); e.setValue("b");
			list.add(e = b3.createBLiteralExpression()); e.setValue("c");
	...
	public void testGetDeclaredType__BExecutionContext() {
		try {
			...
			EList<BExpression> list = block.getExpressions();
			BLiteralExpression e;
			list.add(e = b3.createBLiteralExpression()); e.setValue(1);
			list.add(e = b3.createBLiteralExpression()); e.setValue("hello");
			list.add(e = b3.createBLiteralExpression()); e.setValue(new Double(3.14));
