...
public class BInvocationContextTest extends BExecutionContextTest {
	...
	/**
	 * Tests the '{@link org.eclipse.b3.backend.evaluator.b3backend.BInvocationContext#evaluateIfNotCached(org.eclipse.b3.backend.evaluator.b3backend.BExecutionContext, org.eclipse.b3.backend.evaluator.b3backend.BCachedExpression) <em>Evaluate If Not Cached</em>}' operation.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see org.eclipse.b3.backend.evaluator.b3backend.BInvocationContext#evaluateIfNotCached(org.eclipse.b3.backend.evaluator.b3backend.BExecutionContext, org.eclipse.b3.backend.evaluator.b3backend.BCachedExpression)
	 * @generated NOT
	 */
