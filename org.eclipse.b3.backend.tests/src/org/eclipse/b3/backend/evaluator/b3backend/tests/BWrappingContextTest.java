...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>BWrapping Context</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class BWrappingContextTest extends BDelegatingContextTest {
	...
	public static void main(String[] args) {
		TestRunner.run(BWrappingContextTest.class);
	}
	...
	protected void setUp() throws Exception {
		setFixture(B3backendFactory.eINSTANCE.createBWrappingContext());
	}
