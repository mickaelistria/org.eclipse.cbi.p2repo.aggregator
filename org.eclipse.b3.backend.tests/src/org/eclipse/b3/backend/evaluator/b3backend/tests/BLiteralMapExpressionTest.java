...
public class BLiteralMapExpressionTest extends BExpressionTest {
	...
	public void testEvaluate__BExecutionContext() {
		try {
			...
			e.setKey(key = b3.createBLiteralExpression()); key.setValue("key1");
			BLiteralExpression val;
			e.setValue(val = b3.createBLiteralExpression()); val.setValue(1);
			entries.add(e);

			e = b3.createBMapEntry();
			e.setKey(key = b3.createBLiteralExpression()); key.setValue("key2");
			e.setValue(val = b3.createBLiteralExpression()); val.setValue(2);
			entries.add(e);

			e = b3.createBMapEntry();
			e.setKey(key = b3.createBLiteralExpression()); key.setValue("key3");
			e.setValue(val = b3.createBLiteralExpression()); val.setValue(3);
			entries.add(e);
