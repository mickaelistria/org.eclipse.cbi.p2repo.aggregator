...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>B3 Wildcard Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class B3WildcardTypeTest extends TestCase {
	...
	public static void main(String[] args) {
		TestRunner.run(B3WildcardTypeTest.class);
	}
	...
	protected void setUp() throws Exception {
		setFixture(B3backendFactory.eINSTANCE.createB3WildcardType());
	}
