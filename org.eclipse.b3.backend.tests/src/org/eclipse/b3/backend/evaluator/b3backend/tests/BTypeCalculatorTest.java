...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>BType Calculator</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class BTypeCalculatorTest extends TestCase {
	...
	public static void main(String[] args) {
		TestRunner.run(BTypeCalculatorTest.class);
	}
	...
	protected void setUp() throws Exception {
		setFixture(B3backendFactory.eINSTANCE.createBTypeCalculator());
	}
