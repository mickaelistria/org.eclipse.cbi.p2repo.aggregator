...
/**
 * <!-- begin-user-doc -->
 * A test case for the model object '<em><b>B3 Parameterized Type</b></em>'.
 * <!-- end-user-doc -->
 * <p>
...
public class B3ParameterizedTypeTest extends TestCase {
	...
	public static void main(String[] args) {
		TestRunner.run(B3ParameterizedTypeTest.class);
	}
	...
	protected void setUp() throws Exception {
		setFixture(B3backendFactory.eINSTANCE.createB3ParameterizedType());
	}
