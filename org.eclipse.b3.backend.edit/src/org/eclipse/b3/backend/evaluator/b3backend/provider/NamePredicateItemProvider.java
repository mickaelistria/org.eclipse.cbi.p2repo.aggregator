...
/**
 * This is the item provider adapter for a {@link org.eclipse.b3.backend.evaluator.b3backend.NamePredicate} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class NamePredicateItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_NamePredicate_name_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_NamePredicate_name_feature", "_UI_NamePredicate_type"),
				 B3backendPackage.Literals.NAME_PREDICATE__NAME,
				 true,
				 false,
				 false,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(B3backendPackage.Literals.NAME_PREDICATE__NAME_PATTERN);
		}
	...
	public String getText(Object object) {
		String label = ((NamePredicate)object).getName();
		return label == null || label.length() == 0 ?
			getString("_UI_NamePredicate_type") :
			getString("_UI_NamePredicate_type") + " " + label;
	}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(B3backendPackage.Literals.NAME_PREDICATE__NAME_PATTERN,
