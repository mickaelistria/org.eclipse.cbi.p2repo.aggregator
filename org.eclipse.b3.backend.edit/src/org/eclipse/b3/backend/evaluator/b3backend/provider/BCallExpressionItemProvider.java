 ...
 * @generated
 */
public class BCallExpressionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_BCallExpression_name_feature", "_UI_BCallExpression_type"),
				 B3backendPackage.Literals.BCALL_EXPRESSION__NAME,
				 true,
				 false,
				 false,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == B3backendPackage.Literals.BPARAMETERIZED_EXPRESSION__PARAMETERS ||
			childFeature == B3backendPackage.Literals.BCALL_EXPRESSION__FUNC_EXPR;
