 ...
 * @generated
 */
public class BDefValueItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 B3backendPackage.Literals.BDEF_VALUE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addValueExprPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BDefValue_valueExpr_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BDefValue_valueExpr_feature", "_UI_BDefValue_type"),
	...
	protected void addTypePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_BDefValue_type_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_BDefValue_type_feature", "_UI_BDefValue_type"),
