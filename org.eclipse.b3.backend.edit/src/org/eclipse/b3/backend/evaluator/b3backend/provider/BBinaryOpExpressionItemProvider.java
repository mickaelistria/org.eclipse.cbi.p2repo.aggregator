 ...
 * @generated
 */
public class BBinaryOpExpressionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_BBinaryOpExpression_functionName_feature", "_UI_BBinaryOpExpression_type"),
				 B3backendPackage.Literals.BBINARY_OP_EXPRESSION__FUNCTION_NAME,
				 true,
				 false,
				 false,
