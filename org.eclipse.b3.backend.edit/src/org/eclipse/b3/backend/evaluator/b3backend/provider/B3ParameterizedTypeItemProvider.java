		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_B3ParameterizedType_ownerType_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_B3ParameterizedType_ownerType_feature", "_UI_B3ParameterizedType_type"),
