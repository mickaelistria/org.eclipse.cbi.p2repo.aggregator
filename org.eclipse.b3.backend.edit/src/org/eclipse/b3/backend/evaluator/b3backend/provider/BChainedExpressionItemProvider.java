...
/**
 * This is the item provider adapter for a {@link org.eclipse.b3.backend.evaluator.b3backend.BChainedExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class BChainedExpressionItemProvider extends BExpressionItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public BChainedExpressionItemProvider(AdapterFactory adapterFactory) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BCHAINED_EXPRESSION__EXPRESSIONS, B3backendFactory.eINSTANCE.createBFunction()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BCHAINED_EXPRESSION__EXPRESSIONS, B3backendFactory.eINSTANCE.createB3Function()));
		...
		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BCHAINED_EXPRESSION__EXPRESSIONS, B3backendFactory.eINSTANCE.createBLiteralType()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BCHAINED_EXPRESSION__EXPRESSIONS, B3backendFactory.eINSTANCE.createBDefProperty()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BCHAINED_EXPRESSION__EXPRESSIONS, B3backendFactory.eINSTANCE.createBAdvice()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BCHAINED_EXPRESSION__EXPRESSIONS, B3backendFactory.eINSTANCE.createBPropertySet()));
		...
		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BCHAINED_EXPRESSION__EXPRESSIONS, B3backendFactory.eINSTANCE.createBConcern()));
		...
		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BCHAINED_EXPRESSION__EXPRESSIONS, B3backendFactory.eINSTANCE.createBCallFeature()));
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if(childrenFeatures == null) {
			...
			childrenFeatures.add(B3backendPackage.Literals.BCHAINED_EXPRESSION__EXPRESSIONS);
		}
		return childrenFeatures;
	}

	/**
	 * This returns BChainedExpression.gif.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * 
	 * @generated
	...
	public Object getImage(Object object) {
		return overlayImage(object, getResourceLocator().getImage("full/obj16/BChainedExpression"));
	}
	...
	public void notifyChanged(Notification notification) {
		...
		switch(notification.getFeatureID(BChainedExpression.class)) {
