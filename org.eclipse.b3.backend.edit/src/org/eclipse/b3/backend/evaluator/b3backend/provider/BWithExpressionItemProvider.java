...
public class BWithExpressionItemProvider extends BExpressionItemProvider implements IEditingDomainItemProvider,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_BWithExpression_referencedAdvice_feature", "_UI_BWithExpression_type"),
				 B3backendPackage.Literals.BWITH_EXPRESSION__REFERENCED_ADVICE,
				 true,
				 false,
				 true,
				 null,
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(B3backendPackage.Literals.BWITH_EXPRESSION__CONCERNS,
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == B3backendPackage.Literals.BWITH_EXPRESSION__PROPERTY_SETS ||
