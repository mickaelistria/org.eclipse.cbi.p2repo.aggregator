...
/**
 * This is the item provider adapter for a {@link org.eclipse.b3.backend.evaluator.b3backend.BWithExpression} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * 
 * @generated
 */
public class BWithExpressionItemProvider extends BExpressionItemProvider implements IEditingDomainItemProvider,
	 ...
	 * @generated
	 */
	public BWithExpressionItemProvider(AdapterFactory adapterFactory) {
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__PROPERTY_SETS, B3backendFactory.eINSTANCE.createBPropertySet()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__PROPERTY_SETS,
			B3backendFactory.eINSTANCE.createBDefaultPropertySet()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__CONCERNS, B3backendFactory.eINSTANCE.createBConcern()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBIfExpression()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBSwitchExpression()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBTryExpression()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBOrExpression()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBAndExpression()));
		...
		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBThrowExpression()));
		...
		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBCachedExpression()));
		...
		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBAtExpression()));
		...
		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBCreateExpression()));
		...
		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBFunction()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createB3Function()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBJavaFunction()));
		...
		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBLiteralType()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBDefProperty()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBAdvice()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBPropertySet()));
		...
		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBConcern()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBWithExpression()));

		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBFunctionWrapper()));
		...
		newChildDescriptors.add(createChildParameter(
			B3backendPackage.Literals.BWITH_EXPRESSION__FUNC_EXPR, B3backendFactory.eINSTANCE.createBCallFeature()));
