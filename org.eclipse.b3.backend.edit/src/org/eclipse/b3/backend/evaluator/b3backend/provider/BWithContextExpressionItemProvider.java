 ...
 * @generated
 */
public class BWithContextExpressionItemProvider
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_BWithContextExpression_alias_feature", "_UI_BWithContextExpression_type"),
				 B3backendPackage.Literals.BWITH_CONTEXT_EXPRESSION__ALIAS,
				 true,
				 false,
				 false,
	...
	public String getText(Object object) {
		String label = ((BWithContextExpression)object).getAlias();
	...
	public String getCreateChildText(Object owner, Object feature, Object child, Collection<?> selection) {
		...
		boolean qualify =
			childFeature == B3backendPackage.Literals.BWITH_CONTEXT_EXPRESSION__EXPR ||
