		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 getString("_UI_PropertyDescriptor_description", "_UI_BFunctionWrapper_original_feature", "_UI_BFunctionWrapper_type"),
				 B3backendPackage.Literals.BFUNCTION_WRAPPER__ORIGINAL,
				 true,
				 false,
				 true,
				 null,
