 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.impl.InstallableUnitPatchImpl#getRequirementsChange <em>Requirements Change</em>}</li>
 * <li>{@link org.eclipse.b3.p2.impl.InstallableUnitPatchImpl#getLifeCycle <em>Life Cycle</em>}</li>
...
public class InstallableUnitPatchImpl extends InstallableUnitImpl implements InstallableUnitPatch {
	...
	public IRequirement getLifeCycle() {
		if(lifeCycle != null && ((EObject) lifeCycle).eIsProxy()) {
			...
			if(lifeCycle != oldLifeCycle) {
				...
				NotificationChain msgs = oldLifeCycle.eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						P2Package.INSTALLABLE_UNIT_PATCH__LIFE_CYCLE, null, null);
				if(newLifeCycle.eInternalContainer() == null) {
					msgs = newLifeCycle.eInverseAdd(this, EOPPOSITE_FEATURE_BASE -
							P2Package.INSTALLABLE_UNIT_PATCH__LIFE_CYCLE, null, msgs);
				}
				if(msgs != null)
					msgs.dispatch();
				if(eNotificationRequired())
	...
	public void setLifeCycle(IRequirement newLifeCycle) {
		if(newLifeCycle != lifeCycle) {
			...
			if(lifeCycle != null)
				msgs = ((InternalEObject) lifeCycle).eInverseRemove(this, EOPPOSITE_FEATURE_BASE -
						P2Package.INSTALLABLE_UNIT_PATCH__LIFE_CYCLE, null, msgs);
			if(newLifeCycle != null)
				msgs = ((InternalEObject) newLifeCycle).eInverseAdd(this, EOPPOSITE_FEATURE_BASE -
						P2Package.INSTALLABLE_UNIT_PATCH__LIFE_CYCLE, null, msgs);
