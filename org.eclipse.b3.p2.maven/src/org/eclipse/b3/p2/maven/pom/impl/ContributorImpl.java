 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ContributorImpl#getName <em>Name</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ContributorImpl#getEmail <em>Email</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ContributorImpl#getUrl <em>Url</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ContributorImpl#getOrganization <em>Organization</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ContributorImpl#getOrganizationUrl <em>Organization Url</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ContributorImpl#getRoles <em>Roles</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ContributorImpl#getTimezone <em>Timezone</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ContributorImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ContributorImpl extends EObjectImpl implements Contributor {
	...
	public void setOrganizationUrl(String newOrganizationUrl) {
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(
				this, Notification.SET, PomPackage.CONTRIBUTOR__ORGANIZATION_URL, oldOrganizationUrl, organizationUrl));
	}
	...
	public void setTimezone(String newTimezone) {
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(
				this, Notification.SET, PomPackage.CONTRIBUTOR__TIMEZONE, oldTimezone, timezone));
	}
