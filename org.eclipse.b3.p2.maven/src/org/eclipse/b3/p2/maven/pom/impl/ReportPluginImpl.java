 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ReportPluginImpl#getGroupId <em>Group Id</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ReportPluginImpl#getArtifactId <em>Artifact Id</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ReportPluginImpl#getVersion <em>Version</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ReportPluginImpl#getInherited <em>Inherited</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ReportPluginImpl#getConfiguration <em>Configuration</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ReportPluginImpl#getReportSets <em>Report Sets</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
...
public class ReportPluginImpl extends EObjectImpl implements ReportPlugin {
	...
	public void setConfiguration(ConfigurationType newConfiguration) {
		if(newConfiguration != configuration) {
			...
			eNotify(new ENotificationImpl(
				this, Notification.SET, PomPackage.REPORT_PLUGIN__CONFIGURATION, newConfiguration, newConfiguration));
	}
	...
	public void setVersion(String newVersion) {
		...
		if(eNotificationRequired())
			eNotify(new ENotificationImpl(
				this, Notification.SET, PomPackage.REPORT_PLUGIN__VERSION, oldVersion, version));
	}
