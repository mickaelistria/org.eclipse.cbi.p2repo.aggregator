 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Parent#getArtifactId <em>Artifact Id</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Parent#getGroupId <em>Group Id</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Parent#getVersion <em>Version</em>}</li>
...
public interface Parent extends EObject {
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getParent_RelativePath()
