 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.LicensesType#getLicense <em>License</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getLicensesType()
...
public interface LicensesType extends EObject {
	 ...
	 * The list contents are of type {@link org.eclipse.b3.p2.maven.pom.License}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>License</em>' containment reference list isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 *
	 * @return the value of the '<em>License</em>' containment reference list.
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getLicensesType_License()
