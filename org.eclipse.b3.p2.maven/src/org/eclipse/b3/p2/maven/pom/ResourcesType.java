 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.ResourcesType#getResource <em>Resource</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getResourcesType()
...
public interface ResourcesType extends EObject {
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getResourcesType_Resource()
