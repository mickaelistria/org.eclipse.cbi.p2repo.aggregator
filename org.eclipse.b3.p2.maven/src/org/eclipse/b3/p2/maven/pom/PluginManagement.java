 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.PluginManagement#getPlugins <em>Plugins</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getPluginManagement()
...
public interface PluginManagement extends EObject {
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getPluginManagement_Plugins()
