 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.DistributionManagement#getRepository <em>Repository</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.DistributionManagement#getSnapshotRepository <em>Snapshot Repository</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.DistributionManagement#getSite <em>Site</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.DistributionManagement#getDownloadUrl <em>Download Url</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.DistributionManagement#getRelocation <em>Relocation</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.DistributionManagement#getStatus <em>Status</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getDistributionManagement()
...
public interface DistributionManagement extends EObject {
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getDistributionManagement_DownloadUrl()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getDistributionManagement_Relocation()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getDistributionManagement_Repository()
	 ...
	 * @see #setSite(Site)
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getDistributionManagement_Site()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getDistributionManagement_SnapshotRepository()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getDistributionManagement_Status()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
