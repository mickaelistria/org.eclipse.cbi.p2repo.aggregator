 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.ContributorsType#getContributor <em>Contributor</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getContributorsType()
...
public interface ContributorsType extends EObject {
	 ...
	 * The list contents are of type {@link org.eclipse.b3.p2.maven.pom.Contributor}.
	 * <!-- begin-user-doc -->
	 * <p>
	 * If the meaning of the '<em>Contributor</em>' containment reference list isn't clear, there really should be more of a description here...
	 * </p>
	 * <!-- end-user-doc -->
	 *
	 * @return the value of the '<em>Contributor</em>' containment reference list.
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getContributorsType_Contributor()
