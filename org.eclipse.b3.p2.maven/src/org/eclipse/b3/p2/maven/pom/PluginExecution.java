 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.PluginExecution#getId <em>Id</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.PluginExecution#getPhase <em>Phase</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.PluginExecution#getGoals <em>Goals</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.PluginExecution#getInherited <em>Inherited</em>}</li>
...
public interface PluginExecution extends EObject {
	 ...
	 * @see #unsetId()
	 * @see #setId(String)
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getPluginExecution_Id()
