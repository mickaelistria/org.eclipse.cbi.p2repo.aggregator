 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.BuildImpl#getSourceDirectory <em>Source Directory</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.BuildImpl#getScriptSourceDirectory <em>Script Source Directory</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.BuildImpl#getTestSourceDirectory <em>Test Source Directory</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.BuildImpl#getOutputDirectory <em>Output Directory</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.BuildImpl#getTestOutputDirectory <em>Test Output Directory</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.BuildImpl#getExtensions <em>Extensions</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.BuildImpl#getDefaultGoal <em>Default Goal</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.BuildImpl#getResources <em>Resources</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.BuildImpl#getTestResources <em>Test Resources</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.BuildImpl#getDirectory <em>Directory</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.BuildImpl#getFinalName <em>Final Name</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.BuildImpl#getFilters <em>Filters</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.BuildImpl#getPluginManagement <em>Plugin Management</em>}</li>
...
public class BuildImpl extends EObjectImpl implements Build {
	...
	public void setPluginManagement(PluginManagement newPluginManagement) {
		if(newPluginManagement != pluginManagement) {
			...
			eNotify(new ENotificationImpl(
				this, Notification.SET, PomPackage.BUILD__PLUGIN_MANAGEMENT, newPluginManagement, newPluginManagement));
	}
	...
	public void setResources(ResourcesType newResources) {
		if(newResources != resources) {
			...
			eNotify(new ENotificationImpl(
				this, Notification.SET, PomPackage.BUILD__RESOURCES, newResources, newResources));
	}
