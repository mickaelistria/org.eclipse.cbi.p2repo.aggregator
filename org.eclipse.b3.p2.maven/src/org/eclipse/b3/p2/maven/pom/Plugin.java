 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Plugin#getGroupId <em>Group Id</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Plugin#getArtifactId <em>Artifact Id</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Plugin#getVersion <em>Version</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Plugin#isExtensions <em>Extensions</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Plugin#getExecutions <em>Executions</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Plugin#getDependencies <em>Dependencies</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Plugin#getGoals <em>Goals</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Plugin#getInherited <em>Inherited</em>}</li>
...
public interface Plugin extends EObject {
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getPlugin_GroupId()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getPlugin_Extensions()
