 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.DependencyManagement#getDependencies <em>Dependencies</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getDependencyManagement()
...
public interface DependencyManagement extends EObject {
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getDependencyManagement_Dependencies()
