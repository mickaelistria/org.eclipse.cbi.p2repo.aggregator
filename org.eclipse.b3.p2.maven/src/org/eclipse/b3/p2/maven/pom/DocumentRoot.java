 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.DocumentRoot#getMixed <em>Mixed</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.DocumentRoot#getXMLNSPrefixMap <em>XMLNS Prefix Map</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.DocumentRoot#getXSISchemaLocation <em>XSI Schema Location</em>}</li>
...
public interface DocumentRoot extends EObject {
	...
	/**
	 * Sets the value of the '{@link org.eclipse.b3.p2.maven.pom.DocumentRoot#getProject <em>Project</em>}' containment
	 * reference.
