 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.RepositoryPolicy#isEnabled <em>Enabled</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.RepositoryPolicy#getUpdatePolicy <em>Update Policy </em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.RepositoryPolicy#getChecksumPolicy <em>Checksum Policy </em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getRepositoryPolicy()
...
public interface RepositoryPolicy extends EObject {
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getRepositoryPolicy_ChecksumPolicy()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getRepositoryPolicy_UpdatePolicy()
	 * @model dataType="org.eclipse.emf.ecore.xml.type.String"
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getRepositoryPolicy_Enabled()
