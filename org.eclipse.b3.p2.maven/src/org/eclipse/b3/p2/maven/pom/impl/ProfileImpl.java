 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ProfileImpl#getId <em>Id</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ProfileImpl#getActivation <em>Activation</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ProfileImpl#getBuild <em>Build</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ProfileImpl#getModules <em>Modules</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ProfileImpl#getRepositories <em>Repositories</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ProfileImpl#getPluginRepositories <em>Plugin Repositories</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ProfileImpl#getDependencies <em>Dependencies</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ProfileImpl#getReports <em>Reports</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ProfileImpl#getReporting <em>Reporting</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ProfileImpl#getDependencyManagement <em>Dependency Management</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ProfileImpl#getDistributionManagement <em>Distribution Management</em>}</li>
