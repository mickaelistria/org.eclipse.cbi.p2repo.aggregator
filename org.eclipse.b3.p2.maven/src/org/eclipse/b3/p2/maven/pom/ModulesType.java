 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.ModulesType#getModule <em>Module</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getModulesType()
...
public interface ModulesType extends EObject {
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getModulesType_Module()
