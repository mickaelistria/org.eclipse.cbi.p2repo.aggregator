 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ResourceImpl#getTargetPath <em>Target Path</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ResourceImpl#isFiltering <em>Filtering</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ResourceImpl#getDirectory <em>Directory</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ResourceImpl#getIncludes <em>Includes</em>}</li>
