 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Profile#getId <em>Id</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Profile#getActivation <em>Activation</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Profile#getBuild <em>Build</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Profile#getModules <em>Modules</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Profile#getRepositories <em>Repositories</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Profile#getPluginRepositories <em>Plugin Repositories</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Profile#getDependencies <em>Dependencies</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Profile#getReports <em>Reports</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Profile#getReporting <em>Reporting</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Profile#getDependencyManagement <em>Dependency Management</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Profile#getDistributionManagement <em>Distribution Management</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Profile#getProperties <em>Properties</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getProfile()
...
public interface Profile extends EObject {
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getProfile_Activation()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getProfile_Build()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getProfile_Dependencies()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getProfile_DependencyManagement()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getProfile_DistributionManagement()
	 * @model containment="true"
	 ...
	 * @see #setId(String)
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getProfile_Id()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getProfile_Modules()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getProfile_PluginRepositories()
	 * @model containment="true"
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getProfile_Properties()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getProfile_Reporting()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getProfile_Reports()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getProfile_Repositories()
	...
	/**
	 * Sets the value of the '{@link org.eclipse.b3.p2.maven.pom.Profile#getId <em>Id</em>}' attribute.
	 * <!-- begin-user-doc --> <!-- end-user-doc -->
	 *
	 * @param value
