...
public class PomAdapterFactory extends AdapterFactoryImpl {
	...
	protected PomSwitch<Adapter> modelSwitch = new PomSwitch<Adapter>() {
		...
		@Override
		public Adapter caseNotifier(org.eclipse.b3.p2.maven.pom.Notifier object) {
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ActivationFile
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ActivationOS
	 * <em>Activation OS</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.Build <em>Build</em>}'.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.BuildBase <em>Build Base</em>}'.
	 * <!-- begin-user-doc
	 * --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.CiManagement
	 * <em>Ci Management</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ConfigurationType
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.Contributor
	 * <em>Contributor</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ContributorsType
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.DependenciesType
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.Developer <em>Developer</em>}'.
	 * <!-- begin-user-doc
	 * --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.DevelopersType
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.DocumentRoot
	 * <em>Document Root</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ExcludesType
	 * <em>Excludes Type</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.Exclusion <em>Exclusion</em>}'.
	 * <!-- begin-user-doc
	 * --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ExclusionsType
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ExecutionsType
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.Extension <em>Extension</em>}'.
	 * <!-- begin-user-doc
	 * --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ExtensionsType
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.FiltersType
	 * <em>Filters Type</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.GoalsType <em>Goals Type</em>}'.
	 * <!-- begin-user-doc
	 * --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.IncludesType
	 * <em>Includes Type</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.IssueManagement
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.License <em>License</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.LicensesType
	 * <em>Licenses Type</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.MailingList
	 * <em>Mailing List</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.MailingListsType
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.Model <em>Model</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ModulesType
	 * <em>Modules Type</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.Notifier <em>Notifier</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.NotifiersType
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.Organization
	 * <em>Organization</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.OtherArchivesType
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.Parent <em>Parent</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.Plugin <em>Plugin</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.PluginExecution
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.PluginManagement
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.PluginsType
	 * <em>Plugins Type</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.Prerequisites
	 * <em>Prerequisites</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.Profile <em>Profile</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ProfilesType
	 * <em>Profiles Type</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.PropertiesType
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.Reporting <em>Reporting</em>}'.
	 * <!-- begin-user-doc
	 * --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ReportingPluginsType
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ReportPlugin
	 * <em>Report Plugin</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.ReportSet <em>Report Set</em>}'.
	 * <!-- begin-user-doc
	 * --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ReportSetReportsType
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ReportSetsType
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ReportsType
	 * <em>Reports Type</em>}'. <!--
	 * begin-user-doc --> This default implementation returns null so that we can easily ignore cases; it's useful to
	 * ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.RepositoriesType
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.RepositoryPolicy
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.Resource <em>Resource</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case when
	 * inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.ResourcesType
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.RolesType <em>Roles Type</em>}'.
	 * <!-- begin-user-doc
	 * --> This default implementation returns null so that we can easily ignore cases; it's useful to ignore a case
	 * when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.Scm <em>Scm</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.eclipse.b3.p2.maven.pom.Site <em>Site</em>}'.
	 * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
	 * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
	 * 
	 * @return the new adapter.
	...
	/**
	 * Creates a new adapter for an object of class ' {@link org.eclipse.b3.p2.maven.pom.TestResourcesType
