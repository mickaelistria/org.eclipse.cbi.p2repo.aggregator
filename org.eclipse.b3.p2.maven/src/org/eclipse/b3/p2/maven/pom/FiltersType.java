 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.FiltersType#getFilter <em>Filter</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getFiltersType()
...
public interface FiltersType extends EObject {
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getFiltersType_Filter()
