 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Reporting#isExcludeDefaults <em>Exclude Defaults</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Reporting#getOutputDirectory <em>Output Directory</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Reporting#getPlugins <em>Plugins</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getReporting()
...
public interface Reporting extends EObject {
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getReporting_OutputDirectory()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getReporting_Plugins()
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getReporting_ExcludeDefaults()
