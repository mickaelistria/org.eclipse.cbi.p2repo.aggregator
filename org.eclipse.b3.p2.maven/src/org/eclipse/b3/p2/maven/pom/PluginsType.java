 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.PluginsType#getPlugin <em>Plugin</em>}</li>
 * </ul>
 * </p>
 * 
 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getPluginsType()
...
public interface PluginsType extends EObject {
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getPluginsType_Plugin()
