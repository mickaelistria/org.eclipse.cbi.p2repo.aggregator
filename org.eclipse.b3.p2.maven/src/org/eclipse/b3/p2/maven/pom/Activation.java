 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Activation#isActiveByDefault <em>Active By Default</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Activation#getJdk <em>Jdk</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Activation#getOs <em>Os</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.Activation#getProperty <em>Property</em>}</li>
...
public interface Activation extends EObject {
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getActivation_ActiveByDefault()
