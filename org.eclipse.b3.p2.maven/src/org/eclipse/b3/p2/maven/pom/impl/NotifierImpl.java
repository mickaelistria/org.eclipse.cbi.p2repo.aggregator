 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.NotifierImpl#getType <em>Type</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.NotifierImpl#isSendOnError <em>Send On Error</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.NotifierImpl#isSendOnFailure <em>Send On Failure</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.NotifierImpl#isSendOnSuccess <em>Send On Success</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.NotifierImpl#isSendOnWarning <em>Send On Warning</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.NotifierImpl#getAddress <em>Address</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.NotifierImpl#getConfiguration <em>Configuration</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
