 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getParent <em>Parent</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getModelVersion <em>Model Version</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getGroupId <em>Group Id</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getArtifactId <em>Artifact Id</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getPackaging <em>Packaging</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getName <em>Name</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getVersion <em>Version</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getDescription <em>Description</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getUrl <em>Url</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getPrerequisites <em>Prerequisites</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getIssueManagement <em>Issue Management</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getCiManagement <em>Ci Management</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getInceptionYear <em>Inception Year</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getMailingLists <em>Mailing Lists</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getDevelopers <em>Developers</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getContributors <em>Contributors</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getLicenses <em>Licenses</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getScm <em>Scm</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getOrganization <em>Organization</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getBuild <em>Build</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getProfiles <em>Profiles</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getModules <em>Modules</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getRepositories <em>Repositories</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getPluginRepositories <em>Plugin Repositories</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getDependencies <em>Dependencies</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getReports <em>Reports</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getReporting <em>Reporting</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getDependencyManagement <em>Dependency Management</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getDistributionManagement <em>Distribution Management</em>}</li>
 * <li>{@link org.eclipse.b3.p2.maven.pom.impl.ModelImpl#getProperties <em>Properties</em>}</li>
 * </ul>
 * </p>
 * 
 * @generated
