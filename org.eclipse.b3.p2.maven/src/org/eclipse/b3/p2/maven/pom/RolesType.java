 ...
 * <ul>
 * <li>{@link org.eclipse.b3.p2.maven.pom.RolesType#getRole <em>Role</em>}</li>
 * </ul>
 * </p>
 *
 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getRolesType()
...
public interface RolesType extends EObject {
	 ...
	 * @see org.eclipse.b3.p2.maven.pom.PomPackage#getRolesType_Role()
